...
const ManageSpottedListings = () => {
    ...
    return (
        <Container>
            <Helmet>
        <title>Manage Spotted Listings</title>
      </Helmet>
            <div className="flex flex-col md:flex-row justify-between py-10 lg:gap-10 px-3 lg:px-0">
                <div className="md:w-1/4">
                    <div className="flex flex-col gap-3">
                        <h3 className="text-2xl text-primary bg-blue-300 rounded-xl text-center py-2"> My Account</h3>
                        <NavLink
                            className={({ isActive }) =>
                                isActive
...
export default ManageSpottedListings;
