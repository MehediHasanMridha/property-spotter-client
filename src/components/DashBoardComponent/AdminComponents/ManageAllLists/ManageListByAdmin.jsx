...
const ManageListByAdmin = () => {
  ...
  return (
    <div className="p-6">
         <Helmet>
        <title>Manage Listing By Admin</title>
      </Helmet>
      ...
      <div className="shadow-2xl border-2 border-primary p-5 rounded-md">
                    ...
                    >
                      <div className="modal-box">
                        ...
                        <div className="text-center text-xl">
                          ...
                          <h1>
                            <span className="font-semibold">Sell Time:</span>{" "}
                            <span className="text-primary font-bold text-2xl">
                          ...
                          <div className="modal-box  space-y-10 space-x-5">
                            ...
                            <div className="mt-6 relative">
                              ...
                              >
                                ...
                                {allAgency.map((agency, idx) => (
                                  <option key={idx} value={agency.name} className="text-black">
                                    {agency.name}
                                  </option>
                                ))}
                              </select>
                                ...
                                <div className="mt-6 relative">
                                  ...
                                  >
                                    ...
                                    {allAgent.map((agent, idx) => (
                                      <option key={idx} value={agent.name} className="text-black">
                                        {agent.name}
                                      </option>
                                    ))}
                                  </select>
                            ...
                            <div>
                              <button
                                ...
                                onClick={(e) => handleSubmit(house._id)}
                              >
                                Submit
                              </button>
                            </div>
        ...
        <div className=" flex flex-wrap justify-center mb-10 mt-5">
          ...
          <button
            className="join-item btn btn-outline btn-primary  mr-2"
            onClick={() => paginate(currentPage + 1)}
            disabled={currentPage === Math.ceil(listings.length / HousePerPage)}
          >
